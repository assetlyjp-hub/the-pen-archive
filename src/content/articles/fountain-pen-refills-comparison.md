---
title: "Fountain Pen Refills: Cartridge vs Converter vs Bottled Ink"
description: "A complete comparison of fountain pen refill methods — cartridge, converter, and bottled ink. Cost, convenience, ink selection, and travel considerations explained."
category: "comparison"
tags: ["cartridge", "converter", "bottled ink", "refill", "comparison", "buying guide"]
...
When I refilled my first fountain pen, I had no idea there were three completely different ways to do it. The pen came with a couple of plastic cartridges, but the box also mentioned a "converter" sold separately, and the fountain pen forums I lurked on kept talking about bottled ink. Years later, I have refilled pens with all three methods, and I can tell you that the choice is not just about preference — it affects cost, ink selection, travel safety, and even how often you have to clean your pen.
...
| Method | Cost per fill | Ink capacity | Color selection | Mess factor | Best for |
|---|---|---|---|---|---|
| Cartridge | $0.30 to $2 | 0.7 to 1.4 ml | Limited (5 to 30 colors) | Zero | Travel, students, beginners |
| Converter | About $0.10 (with bottle) | 0.5 to 1.0 ml | Unlimited | Low | Daily writers wanting variety |
| Bottled ink (direct) | About $0.05 (with bottle) | 1.2 to 2.0 ml | Unlimited | Medium | Enthusiasts, home use |
...
- **Pilot** — uses its own IC-100 cartridge, available in six colors
- **LAMY** — uses the T10 cartridge, available in eight colors (cannot be used with non-LAMY pens)
- **Cross** — uses a proprietary cartridge that fits only Cross pens
- **Pelikan** — uses International Standard, but the brand's own cartridges are widely available
- **Sailor** — uses its own cartridge format with about six colors
- **Platinum** — uses its own cartridge format, also fits Platinum's own bottled ink converters
...
- **LAMY Safari** ($30) — eight colors of T10 cartridges, easy to find
- **Pilot Kakuno** ($18) — friendly student pen, IC-100 cartridges
- **Kaweco Sport** ($28) — pocket-sized, takes International Standard
...
- **Pilot Custom 74** ($160) — gold nib, takes the excellent CON-70 converter
- **Platinum #3776 Century** ($90) — Slip and Seal cap pairs beautifully with the bottled-ink workflow
- **TWSBI Swipe** ($30) — comes with both a converter and an oversized cartridge
...
- **Daily-driver pen at home:** Pelikan M400, piston filler, bottled Iroshizuku Kon-peki
- **Office pen:** Pilot Custom 74 with CON-70 converter, bottled Sailor 161
- **Travel pen:** LAMY Safari with T10 cartridges, blue-black for predictability
- **Pocket pen for errands:** Kaweco Sport with cartridges
