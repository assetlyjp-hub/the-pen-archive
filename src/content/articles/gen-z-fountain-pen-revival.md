---
title: "Why Gen Z Is Ditching Screens for Fountain Pens: The Analog Writing Revival"
description: "Fountain pens are having a moment with Gen Z. From TikTok to journaling culture, discover why young writers are embracing analog tools — and the best pens to start with."
category: "guide"
...
- **Shading** — ink pools darker in some areas and lighter in others, creating beautiful variation within a single color
- **Sheening** — certain inks produce a metallic sheen on top of the base color (like a red sheen on a dark blue ink)
- **Shimmer** — tiny metallic particles suspended in the ink that sparkle on the page
- **Water resistance** — some inks are waterproof or water-resistant, important if your notes might get wet
- **Dry time** — how quickly ink dries on paper, which matters for lefties and anyone who smudges

### Recommended Starter Inks

- **Pilot Iroshizuku Kon-peki** — a stunning blue with beautiful shading, one of the most universally loved inks in the hobby
- **Diamine Oxblood** — a rich, dark red that looks sophisticated in any pen
- **Waterman Serenity Blue** — a well-behaved, easy-to-clean blue that works in every pen
- **Pilot Blue-Black** — the workhorse, a professional blue-black that is water-resistant and works in any setting
